/* Custom site scripts extracted from the WordPress page "connected-devices".
...
const connectedSection = document.querySelector("#connected-number");
...
observer.observe(connectedSection);
})();
} catch (e) {
