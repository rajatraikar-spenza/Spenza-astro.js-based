...
document.addEventListener("DOMContentLoaded", function () {
  ...
  // No exit-intent popup on the home page: it used to open ten seconds after
  // the pointer left through the top of the window, and was removed on request.
  // The popup now opens only when a visitor asks for it, from a button above.
