/* Custom site scripts extracted from the WordPress page "post-spenza-global-connectivity-kids-smartwatch".
...
(function(){
(function(){
        const popup = document.querySelector('#emailPopup_2');

        window.openPopup_2 = function(){
            if(popup) popup.style.display = 'flex';
        }

        window.closePopup_2 = function(){
