...
| existing preview | 19: [launch-mvno-us-guide-featured.png](../../public/blog-media/mvno-us-launch/launch-mvno-us-guide-featured.png) | Reject | Previous preview featured image was generated whole and violates the fixed template. |
| existing preview | 20: [mvno-cost-timeline-build-vs-mvne.png](../../public/blog-media/mvno-us-launch/mvno-cost-timeline-build-vs-mvne.png) | Reject | Previous cost/timeline graphic contains unsupported price and launch-duration bands. |
| existing preview | 21: [mvno-customer-evidence-strip.png](../../public/blog-media/mvno-us-launch/mvno-customer-evidence-strip.png) | Reject | Previous customer strip turns unapproved launch times and geographic counts into evidence. |
| existing preview | 22: [mvno-model-ladder.png](../../public/blog-media/mvno-us-launch/mvno-model-ladder.png) | Reject | Previous ladder incorrectly mixes IoT and embedded use cases with operating depth. |
