...
tokens, dimensions, the five composition types, alt-text rules and the failure
catalogue. Read it before writing a prompt. This file is the procedure.
...
`docs/blog-images.md` §5 — copy it verbatim, do not paraphrase it. The brief
...
Pick the composition type from §6: **A** comparison, **B** process/timeline,
...
## Step 4 — Optimise what comes back
